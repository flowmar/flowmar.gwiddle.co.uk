...
function clickable() {
  ...
  $('#liri').on('click', function() {
    ...
    $('#button-area-1').html(
      '<a href="https://flowmar.gwiddle.co.uk/projects/3-back-end/1-liri-bot-node/liri-screenshots.html"><button class="btn btn-unique animated bounceIn" type=button title="Screenshots">Screenshots</button></a><a href= "https://github.com/flowmar/liri-bot"> <button class="btn btn-indigo animated rollIn" type="button" title="Source Code">Source Code</button></a><a href="https://github.com/flowmar/liri-bot/blob/master/README.md"><button class="btn-deep-orange btn animated fadeIn" type=button title="READ ME!">README</button></a>'
    );
