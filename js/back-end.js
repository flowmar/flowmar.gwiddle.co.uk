...
function clickable() {
  ...
  $("#kablamazon").on("click", function() {
    $(this).addClass("active");
    $("#button-area-2").html(
      '<a href="https://flowmar.gwiddle.co.uk/projects/3-back-end/2-kablamazon-sql/kablamazon-screenshots.html" target="_blank"><button class="btn btn-unique animated bounceIn" type=button title="Screenshots">Screenshots</button></a><a href= "https://github.com/flowmar/Kablamazon" target="_blank"> <button class="btn btn-indigo animated rollIn" type="button" title="Source Code">Source Code</button></a><a href="https://github.com/flowmar/Kablamazon/blob/master/README.md" target="_blank"><button class="btn-deep-orange btn animated fadeIn" type=button title="READ ME!">README</button></a>'
    );
    $("#kablamazon").on("click", function() {
      $(this).removeClass("active");
      $("#button-area-2").empty();
