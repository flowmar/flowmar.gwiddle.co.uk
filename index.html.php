...
<section class="container-fluid">
    ...
    <br><br><br><br>
    <div class="row pull-left text-left mt-1 mb-3">
        <div
            class="text-danger animated rollIn col-4"
            id="toy"
            title="Shameless Self-Promotion">and a flow propsmith.
        </div>
        <br>
        <br>
    </div>
...
<section class="row justify-content-center pt-4">
    <div
        ...
        <br>
        <hr>
        <span class="display-2 text-center font-weight-bold animated tada">News and Updates</span>
        <hr class="white">
        <p class="mb-2" title="This is a tooltip, bruh.">
            <br>
            <span class="h3 text-center">October 17, 2017</span>
            <br>
            <ul class="p-2">
                <li>
                    My
