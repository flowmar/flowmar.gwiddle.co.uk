...
<div class="row text-center animated rubberBand">
    <div class="col-12">
        <button
            class="btn btn-primary unique-color raised round animated bounceInLeft"
            id="liri"
            type="button"
            title="Liri">
        ...
        <div class="row animated fadeIn">
            <div class="col text-center">
                <a href="../../code" title="Go Back">
                    <button
                        class="btn btn-secondary purple-gradient raised animated fadeIn"
                        type="button">
...
<script src="../../js/back-end.js"></script>
</body>
